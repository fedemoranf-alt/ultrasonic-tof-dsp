...
% -> Correlacion del eco crudo
% -> Correlacion de la envolvente
% -> Correlacion de la derivada con interpolacion de la envolvente
% -> Correlacion de la derivada de la envolvente interpolada y promediado del eco para el patron
% -> Correlacion  de la derivada de la envolvente del eco interpolado

% se incluyen los 5 algoritmos en este script para ya generar los 5
...
%digitalizados2 por el psoc, se utiliza el vector del eco
...
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\eco_crudo2.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
% para asi poder hacer clear all y close all para no afectar al
% procesamiento del siguiente algoritmo
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\envolvente2.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
%% Algoritmo con la derivada  DE LE ENVOLVENTE interpolada
...
% para asi poder hacer clear all y close all para no afectar al
% procesamiento del siguiente algoritmo
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\env_int2.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
%% DERIVADA CON ENVOLVENTE INTERPOLADA CON PROMEDIADO DEL ECO 
...
% para asi poder hacer clear all y close all para no afectar al
% procesamiento del siguiente algoritmo
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\env_int_prom2.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
% para asi poder hacer clear all y close all para no afectar al
% procesamiento del siguiente algoritmo
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\eco_int2.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
%% Eco crudo
SNR1 = 5; SNR2 = 15; SNR3 = 25; SNR4 = 35;
aux = load('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\eco_crudo2.mat');
...
title('Eco Crudo, SNR 1')

subplot(412)
errorbar(valor_real,error_SNR2, sigma_dist_SNR2)
title('Eco Crudo, SNR 2')

subplot(413)
errorbar(valor_real,error_SNR3, sigma_dist_SNR3)
title('Eco Crudo, SNR 3')

subplot(414)
errorbar(valor_real,error_SNR4, sigma_dist_SNR4)
title('Eco Crudo, SNR 4')

clear all
%% ENVOLVETE
SNR1 = 5; SNR2 = 15; SNR3 = 25; SNR4 = 35;
aux = load('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\envolvente2.mat');
...
subplot(411)
errorbar(valor_real,error_SNR1, sigma_dist_SNR1)
title('Envolvente, SNR 1')

subplot(412)
errorbar(valor_real,error_SNR2, sigma_dist_SNR2)
title('Envolvente, SNR 2')

subplot(413)
errorbar(valor_real,error_SNR3, sigma_dist_SNR3)
title('Envolvente, SNR 3')

subplot(414)
errorbar(valor_real,error_SNR4, sigma_dist_SNR4)
title('Envolvente, SNR 4')

clear all
%% DERIVADA INTERPOLADA
SNR1 = 5; SNR2 = 15; SNR3 = 25; SNR4 = 35;
aux = load('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\env_int2.mat');
...
subplot(411)
errorbar(valor_real,error_SNR1, sigma_dist_SNR1)
title('Interpolación de la Envolvente, SNR 1')

subplot(412)
errorbar(valor_real,error_SNR2, sigma_dist_SNR2)
title('Interpolación de la Envolvente, SNR 2')

subplot(413)
errorbar(valor_real,error_SNR3, sigma_dist_SNR3)
title('Interpolación de la Envolvente, SNR 3')

subplot(414)
errorbar(valor_real,error_SNR4, sigma_dist_SNR4)
title('Interpolación de la Envolvente, SNR 4')

clear all
%% DERIVADA CON INTERPOLACION Y PROMEDIADO
SNR1 = 5; SNR2 = 15; SNR3 = 25; SNR4 = 35;
aux = load('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\env_int_prom2.mat');
...
subplot(411)
errorbar(valor_real,error_SNR1, sigma_dist_SNR1)
title('Interpolación  de la Envolvente con Promedio, SNR 1')

subplot(412)
errorbar(valor_real,error_SNR2, sigma_dist_SNR2)
title('Interpolación  de la Envolvente con Promedio, SNR 2')

subplot(413)
errorbar(valor_real,error_SNR3, sigma_dist_SNR3)
title('Interpolación  de la Envolvente con Promedio, SNR 3')

subplot(414)
errorbar(valor_real,error_SNR4, sigma_dist_SNR4)
title('Interpolación  de la Envolvente con Promedio, SNR 4')

clear all
%% DERIVADA CON INTERPOLACION DEL ECO
SNR1 = 5; SNR2 = 15; SNR3 = 25; SNR4 = 35;
aux = load('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\eco_int2.mat');
...
subplot(411)
errorbar(valor_real,error_SNR1, sigma_dist_SNR1)
title('Interpolación Del Eco, SNR 1')

subplot(412)
errorbar(valor_real,error_SNR2, sigma_dist_SNR2)
title('Interpolación Del Eco, SNR 2')

subplot(413)
errorbar(valor_real,error_SNR3, sigma_dist_SNR3)
title('Interpolación Del Eco, SNR 3')

subplot(414)
errorbar(valor_real,error_SNR4, sigma_dist_SNR4)
title('Interpolación Del Eco, SNR 4')
