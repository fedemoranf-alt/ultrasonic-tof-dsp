...
aux = load('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\medidas_paper\ecos_digitalizados_no_interf_en_cero.mat');
eco = aux.ecos;
...
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\eco_crudo_no_interf_en_cero.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
% para asi poder hacer clear all y close all para no afectar al
% procesamiento del siguiente algoritmo
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\envolvente__no_interf_en_cero.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
% para asi poder hacer clear all y close all para no afectar al
% procesamiento del siguiente algoritmo
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\env_int_no_interf_en_cero.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
while (prom_count < 11) %promediaremos 10 medidas
    ...
    eco_refe = squeeze(eco(1,prom_count,:));
    %eco_refe = awgn(eco_refe,SNR);
...
% para asi poder hacer clear all y close all para no afectar al
% procesamiento del siguiente algoritmo
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\env_int_prom_no_interf_en_cero.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
...
% para asi poder hacer clear all y close all para no afectar al
% procesamiento del siguiente algoritmo
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\comp_SNR\eco_int_no_interf_en_cero.mat','Distancia_SNR1','Distancia_SNR2','Distancia_SNR3','Distancia_SNR4')
close all
clear all
