%% medidor de distancia con interpolacion de la envolvente.

%tambien se usa este script para probar el filtro fir_dem2
...
while(count_dist < 22)
    ...
    %         title("Env Int medida")
            ...
            %suavizado de la derivada con un filtro fir
...
%save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\int_tia_gauss.mat','TOF1_v','TOF2_v','Distancia','temperatura')
save('D:\Google Drive\TESIS FM\Scrips Matlab\psoc_med_dis\int_dem2_tia_gauss.mat','TOF1_v','TOF2_v','Distancia','temperatura')
